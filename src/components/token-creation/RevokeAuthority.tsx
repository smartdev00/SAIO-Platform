  ...
  return (
    <div className=''>
      ...
      <p className='text-text-secondary text-sm mb-6'>
        Solana Token has 3 authorities: Freeze Authority, Mint Authority, and Update Authority. Revoke them to attract more
        investors. We highly recommend enabling these 3 options for gaining more trust.
      </p>
