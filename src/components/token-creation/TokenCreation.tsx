      ...
      {currentProgress !== 0 && (
        <div className='space-y-4 mb-12'>
          ...
          <p className='text-xs sm:text-xl text-text-secondary text-center'>
            The cost of creating the token is <span className='text-text-main'>{configData.fee} SOL</span>, which covers all fees
          ...
          {currentProgress === 0 && (
            <div className='relative flex flex-col items-center space-y-8 create-token-first w-full p-4 sm:p-8'>
              <div className='space-y-4'>
                <h2 className='text-2xl sm:text-5xl text-text-main text-center'>Create Solana Token!</h2>
                <p className='text-xs sm:text-xl text-text-secondary text-center'>
                  The cost of creating the token is <span className='text-[#c0a3ff]'>{configData.fee} SOL</span>, which covers all
          ...
          {currentProgress !== 0 && (
            <div className='w-full flex flex-1 justify-end pt-4'>
              <GradientButton
                ...
                disabled={
                  (currentProgress === 1 &&
                    (!!tokenMetaData.name === false || !!tokenMetaData.symbol === false || !!tokenMetaData.logo === false)) ||
